...
while True:
    ...
    # Display class name and probability on original image
    cv2.putText(imgOrignal, className, (120, 35),
                font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(imgOrignal, str(round(probabilities[classIndex]*100, 2))+"%", (180, 75),
                font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
